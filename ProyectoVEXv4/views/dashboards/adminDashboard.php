...
<head>
    ...
    <style>
        ...
        .vex-table td { padding: 12px; border-bottom: 1px solid #eee; vertical-align: middle; }
        ...
        .no-participa { color: #ccc; font-style: italic; font-size: 0.85rem; }
        ...
        /* Estilos para las secciones de jueces */
        .jueces-section-header {
            margin-top: 15px;
            margin-bottom: 10px;
            padding-bottom: 5px;
        ...
        .juez-item:hover { background: #f0f4f8; }
    </style>
</head>
<body>
            ...
            <div id="asignacion" class="section-view">
                <div class="content-card">
                    ...
                    <form action="../../controllers/control_asignar_jueces.php" method="POST">
                        <select name="idCategoria" id="selectCategoriaAsignacion" class="form-control" onchange="cargarJuecesValidos(this)">
                            <option value="">-- Selecciona Categoría --</option>
                            <?php foreach($listaCategorias as $cat): ?>
                                <option value="<?php echo $cat['idCategoria']; ?>" data-nombre="<?php echo htmlspecialchars($cat['nombre']); ?>">
                                    <?php echo htmlspecialchars($cat['nombre']); ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                        <div id="areaJueces" style="margin-top:20px; display:none;">
                            <label style="display:block; margin-bottom:10px;">Selecciona Jueces (Máx 3):</label>
                            
                            <!-- Contenedor para la generación dinámica -->
                            <div id="listaJuecesCheckboxes"></div>
                            
                            <button type="submit" class="btn-action" style="margin-top:20px;">Asignar</button>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <tbody>
                            <?php foreach($listaUsuarios as $u): ?>
                                <?php 
                                    ...
                                    $esEntrenador = ($u['rol_detectado'] == 'Entrenador' || $u['rol_detectado'] == 'Ambos');
                                    $esJuez = ($u['rol_detectado'] == 'Juez' || $u['rol_detectado'] == 'Ambos');
                                ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ($esEntrenador): ?>
                                        <div style='color:#155724; font-weight:bold;'>
                                            ...
                                            <?php echo !empty($u['cat_entrenador']) ? htmlspecialchars($u['cat_entrenador']) : 'Sin equipos'; ?>
                                        </div>
                                    <?php else: ?>
                                        <span class="no-participa">No participa</span>
                                    <?php endif; ?>
                                </td>
                                ...
                                <td>
                                    <?php if ($esJuez): ?>
                                        <div style='color:#721c24; font-weight:bold;'>
                                            ...
                                            <?php echo !empty($u['cat_juez']) ? htmlspecialchars($u['cat_juez']) : 'Sin asignar'; ?>
                                        </div>
                                    <?php else: ?>
                                        <span class="no-participa">No participa</span>
                                    <?php endif; ?>
    ...
    <div id="modalEditarUsuario" class="modal">
        <div class="modal-content">
            ...
            <form action="../../controllers/control_editar_usuario.php" method="POST">
                ...
                <label>Categoría Asignada (Solo Jueces):</label>
    ...
    <script src="../../assets/js/admin_dashboard_custom.js"></script>
